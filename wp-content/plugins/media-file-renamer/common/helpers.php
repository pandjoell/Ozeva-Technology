...
if ( !class_exists( 'MeowKit_MFRH_Helpers' ) ) {

  class MeowKit_MFRH_Helpers {
    //public static $version = MeowKit_MFRH_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_MFRH_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_MFRH_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_MFRH_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_MFRH_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_MFRH_Helpers::$startQueries[ $timerName ];
  ...
  // if ( MeowKit_MFRH_Helpers::is_rest() ) {
