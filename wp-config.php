...
//     define('WP_HOME', 'http://192.168.8.203');
//     define('WP_SITEURL', 'http://192.168.8.203');
//     define( 'WP_SITEURL', $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] );
//     define( 'WP_HOME',    $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] );
//     define('WP_SITEURL', $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/ozeva.com');
//     define('WP_HOME',    $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/ozeva.com');
// }
...
define('WP_HOME', 'http://192.168.8.203/ozeva.com');
define('WP_SITEURL', 'http://192.168.8.203/ozeva.com');
